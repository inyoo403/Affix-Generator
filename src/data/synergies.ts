...
export const SYNERGY_CONFLICTS: SynergyConflict[] = [
  ...
  },
  {
    ...
    tagB: 'dark',
    type: 'synergy',
    synergyBonus: { CHS: 8, ATK: 3 },
  },
  {
    tagA: 'alive',
    tagB: 'smart',
    type: 'synergy',
    synergyBonus: { CHS: 6, SPD: 4, LCK: 3 },
  },
  {
    tagA: 'berserk',
    tagB: 'strong',
...
export const COMBO_BLENDS: ComboBlend[] = [
  ...
  },
  {
    ...
    bonusStats: { ATK: 10, SPD: 6, DEF: 4, CHS: 5 },
  ...
  },
  {
    ...
    bonusStats: { ATK: 8, DEF: 8, LCK: 12, CHS: 6 },
  ...
  },
  {
    ...
    bonusStats: { CHS: 15, SPD: 10, ATK: 5 },
